...
class AddDevice extends Component {
   ...
   render() {
     ...
     function InsertText(props) {
        return <Typography>{'Add New Device'}</Typography>;
      }
      
      function EditText(props) {
          return <Typography>{'Edit Device'}</Typography>;
      }
...
const connectedAddUserPage = withRouter(connect(mapStateToProps, null, null, {
    pure: false
})(withStyles(styles)(AddDevice)));

export { connectedAddUserPage as AddDevice };